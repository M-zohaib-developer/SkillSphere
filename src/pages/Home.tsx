...
const Home: React.FC = () => {
  ...
  const features = [
    ...
    },
    {
      ...
      description: 'Connect with fellow learners, share projects, and grow together in our supportive community.',
    },
    {
      icon: Trophy,
      title: 'Achievements & Certificates',
      description: 'Earn certificates and badges as you complete courses and demonstrate your skills.',
    },
    {
      icon: Target,
      title: 'Personalized Learning',
      description: 'AI-powered recommendations help you find the perfect learning path for your goals.',
    },
  ];
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 lg:py-32">
          <div className="text-center">
            ...
            <p className="text-xl md:text-2xl mb-8 max-w-3xl mx-auto text-gray-200">
              Join thousands of learners on SkillSphere, the premier platform for skill development. 
              From coding to design, business to creative arts - your learning journey starts here.
            </p>
      ...
      <div className="py-24">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className={`text-xl mb-8 ${theme === 'dark' ? 'text-gray-300' : 'text-gray-600'}`}>
            Join our community of learners and start building the skills that matter most to you.
          </p>
          <Link
            to={isAuthenticated ? '/dashboard' : '/register'}
