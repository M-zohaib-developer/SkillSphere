...
import { enrollCourse, addCertification, PaidCourse } from "../utils/storage";
...
const PaidCourses: React.FC = () => {
  ...
  const handleOpenAndEnroll = (course: Course) => {
    const confirmed = window.confirm(
      "Are you sure you want to enroll in this course?"
    );
    if (!confirmed) return;
    enrollCourse(course);
    const newWindow = window.open(course.link, "_blank", "noopener,noreferrer");
    // After returning focus, ask certification; browsers may restrict focus/blur listeners, so re-ask when the user clicks certify button below.
    if (!newWindow) return;
  };
            ...
            >
              ...
              <div className="p-5">
                ...
                <div className="flex items-center justify-between mb-3">
                  ...
                  <button
                    onClick={() => handleOpenAndEnroll(course)}
