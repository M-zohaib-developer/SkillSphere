...
const Dashboard: React.FC = () => {
  ...
  const stats = [
    {
      ...
      value: String(progress.enrolledCourses.length),
      icon: BookOpen,
      color: "text-blue-600",
    },
    {
      label: "Hours Learned",
      value: String(progress.totalHours),
      icon: Clock,
      color: "text-green-600",
    },
    {
      label: "Certificates",
      value: String(progress.certifications),
      icon: Trophy,
  ...
  const enrolled = progress.enrolledCourses.slice(0, 4);
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
          {stats.map((stat, index) => (
            <div
              ...
              } p-6 rounded-lg shadow-sm border hover:shadow-md transition-shadow duration-200`}
            >
